...
close all
Ts = 0.002;
x0=[0,pi+pi/10,0,0].'; % [x1 x2 x1_dot x2_dot]
...
C_aug = [C zeros(2,2)];
B_aug = [B ;0;0];
w_estimator = -50; % mindestens 5 mal schneller als streckenpole, abtastfrequenz fragen
...
%
a4 = 1; a0 = 0; a1 =-29.8113 ; a2 =-97.8748   ; a3 =1.8740; % eq x =0
...
Cz1 = [1 0 0 0]; 
Cr1 = Cz1* inv(Tr);
Qz =  inv(Cr1*inv(Ar-Br*r')*Br)*Cr1*inv(Ar-Br*r')*Bzr; %!!!!!ANDERES VZ!!!!!!!
