...
register(id="hmap_hopper-v0", entry_point="seagul.envs.mujoco:HmapHopperEnv")
...
register(id="pbmj_walker2dfc-v0", entry_point="seagul.envs.bullet:PBMJWalker2dFCEnv")
